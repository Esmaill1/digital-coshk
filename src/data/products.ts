...
export const products: Product[] = [
  ...
  },
  {
    ...
    descriptionAr: 'استماع للموسيقى بدون إعلانات لمدة 3 أشهر.',
    imageUrl: 'https://placehold.co/400x300/1db954/ffffff?text=Spotify',
  },
  {
    id: '5',
    name: 'NordVPN (1 Year)',
    nameAr: 'نورد في بي إن (سنة واحدة)',
    price: 60.00,
    currency: 'USD',
    category: 'VPN',
    description: 'Secure internet access for 1 year.',
    descriptionAr: 'وصول آمن للإنترنت لمدة سنة.',
  ...
  },
  {
    ...
    descriptionAr: 'مفتاح تفعيل لنظام ويندوز 11 برو.',
